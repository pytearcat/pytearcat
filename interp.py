...
########################         AQUI COMIENZA           PyTensor - dist_to_latex
...
def index_counter(element):
    ...
    for string in list_strings:
        ...
        counter=collections.Counter(symbol_index_list)
...
def info_tensor_index(element,sum_over_diz_index,mlist_tensor_term_index):
    ...
    mlist_tensor_term_no_sum_index = copy.deepcopy(mlist_tensor_term_index)
